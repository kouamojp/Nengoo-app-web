...
const PWAInstallPrompt = () => {
  ...
  return (
    <div className="fixed bottom-8 left-4 right-4 sm:left-auto sm:right-4 sm:w-80 bg-gradient-to-r from-purple-600 to-red-600 text-white p-4 rounded-lg shadow-xl z-50 animate-bounce">
